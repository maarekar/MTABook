...
router.put('/suspend/:id', user.verifyToken, user.check_validation_token, (req, res) => { admin.suspend_user(req, res) })
router.put('/restore/:id', user.verifyToken, user.check_validation_token, (req, res) => { admin.restore_user(req, res) })
