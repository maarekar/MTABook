...
router.post('/register', user.verifyToken, user.check_validation_token, async (req, res) => { user.register(req, res) })
router.post('/approve', user.verifyToken, user.check_validation_token, (req, res) => { admin.approve_user(req, res) })
router.put('/suspend', user.verifyToken, user.check_validation_token, (req, res) => { admin.suspend_user(req, res) })
